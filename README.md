...
## 🎥 Demo
Click to watch a short walkthrough of the gameplay, including puzzle interaction, validation, and completion flow:

▶️ [![Watch Sudoku Demo](src/assets/demo/sudoku-demo-thumbnail.png)](https://youtu.be/8nav2S8SSgQ)
